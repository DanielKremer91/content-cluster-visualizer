...
<div style="background-color: #f2f2f2; color: #000000; padding: 15px 20px; border-radius: 6px; font-size: 0.9em; max-width: 600px; margin-bottom: 1.5em; line-height: 1.5;">
  ...
  Folge mir auf <a href="https://www.linkedin.com/in/daniel-kremer-b38176264/" target="_blank">LinkedIn für mehr SEO-Insights und Tool-Updates</a>
</div>
<hr>
...
export_lowrel_csv = st.sidebar.checkbox(
    ...
    help=("Low-Relevance URLs (thematische Ausreißer-URLs) als CSV exportieren. "
          "Beispielsweise alle URLs mit einer Cosinus Similarity von unter 0,4 mit dem arithmetischen Mittelwert aller Embedding-Vektoren (Centroid) können als Ausreißer bezeichnet werden. "
